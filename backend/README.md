...
## Project Structure
    ...
    ├── testapiautocatalog_105147  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_105147`
...
2. Clone this repo and `cd testapiautocatalog_105147`
